...
import FormFieldArrayImg from "./FormFieldNumber";
        ...
        <Form
          ...
          render={({ handleSubmit, form, submitting, pristine, values }) => (
            <form onSubmit={handleSubmit}>
              ...
              <Card>
                <Label>Images</Label>
                {/* <FormFieldText key={0} name={0} hint="Image URL" value={this.state.aObj.images[0]} /> */}
                {/* <FormFieldText key={1} name={1} hint="Image URL" value={this.state.aObj.images[1]} /> */}
                {/* <FormArray> */}
                  {this.state.aObj.images?.map((item, i) => (
                    //   <p key={i}>{item.view} - {item.src}</p>
                    <FormFieldArrayImg
                      key={i}
                      name={item.view}
                      hint="Image URL"
